...
// POST: /api/v1/agent-role
describe("POST: /api/v1/agent-role", () => {
...
// PUT: /api/v1/agent-role
describe("PUT: /api/v1/agent-role/:id", () => {
  it("should return 200", async () => {
    const res = await request(server)
      .put(`/api/v1/agent-role/${guest_roleID}`)
      .set("Authorization", `Bearer ${token}`)
      .send({
        roleID: createdRole,
        guestID: guestID,
...
// DELETE: /api/v1/agent-role
describe("DELETE: /api/v1/agent-role/:id", () => {
  it("should return 200", async () => {
    const res = await request(server)
      .delete(`/api/v1/agent-role/${updatedGuestRole}`)
      .set("Authorization", `Bearer ${token}`);
    expect(res.status).toBe(200);
    expect(res.body.data).toHaveProperty("id");
  });
...
// GET: /api/v1/agent-role
describe("GET: /api/v1/agent-role", () => {
  it("should return 200", async () => {
    const res = await request(server)
      .get("/api/v1/agent-role")
      .set("Authorization", `Bearer ${token}`);
...
// GET: /api/v1/agent-role/:id
describe("GET: /api/v1/agent-role/:id", () => {
  it("should return 200", async () => {
    const res = await request(server)
      .get(`/api/v1/agent-role/${guest_roleID}`)
      .set("Authorization", `Bearer ${token}`);
    expect(res.status).toBe(200);
    expect(res.body.data).toHaveProperty("id");
  });
